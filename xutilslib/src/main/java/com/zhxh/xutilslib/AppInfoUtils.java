...
public class AppInfoUtils {
    ...
    private static List<Application> getApplicationInfo(Context context, ApplicationType applicationType) {
        ...
        for (PackageInfo packageInfo : packageInfoList) {
            ...
            application.getApplicationInfo().loadLabel(context.getPackageManager());
            application.getApplicationInfo().loadIcon(context.getPackageManager());
            application.getApplicationInfo().packageName = packageInfo.packageName;
            application.getApplicationInfo().name = packageInfo.versionName;
